...
export const metadata = {
  title: "About Us | EazWorld — Digital Agency in Accra, Ghana",
  description: "EazWorld is a digital agency based in Accra, Ghana. We build websites, run SEO and marketing campaigns, and repair phones for businesses across Ghana.",
  openGraph: {
    title: "About EazWorld | Digital Agency in Accra, Ghana",
    description: "Meet the team behind EazWorld — web design, SEO, branding and phone repair in Accra, Ghana.",
    url: "https://eazworld.com/about",
  },
  alternates: { canonical: "https://eazworld.com/about" },
};
  ...
  return (
    <div className="bg-gray-50 dark:bg-slate-950 text-gray-900 dark:text-white">
      ...
      <section className="py-20 px-4">
        <div className="max-w-3xl mx-auto space-y-5 text-gray-600 dark:text-slate-400 leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {approach.map((s) => (
              <div key={s.num} className="flex gap-4">
                <span className="font-display font-bold text-2xl text-gray-200 dark:text-slate-700 flex-shrink-0 w-10">{s.num}</span>
                <div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="font-display font-bold text-3xl text-gray-900 dark:text-white mb-4">Ready to Build Something Together?</h2>
