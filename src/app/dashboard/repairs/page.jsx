  ...
  return (
    <div className="max-w-6xl mx-auto px-4 pt-6 pb-20">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/services/phone-repair" className="text-xs font-semibold px-4 py-2 rounded-full bg-gray-900 dark:bg-brand-500 text-white dark:text-gray-900 hover:bg-gray-700 dark:hover:bg-brand-400 transition">
          Book a Repair
        </Link>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 p-10 text-center">
          ...
          <p className="text-gray-400 dark:text-slate-500 text-sm mb-2">No repairs linked to your account.</p>
          <p className="text-xs text-gray-300 dark:text-slate-600 mb-4">Device repairs you book in-store appear here once matched to your phone number.</p>
          <Link href="/services/phone-repair" className="text-sm font-semibold px-5 py-2.5 rounded-full bg-gray-900 dark:bg-brand-500 text-white dark:text-gray-900 hover:bg-gray-700 dark:hover:bg-brand-400 transition">
            Learn about repairs
          </Link>
        </div>
      ) : (
