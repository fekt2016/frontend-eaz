  ...
  return (
    <div className="max-w-6xl mx-auto px-4 pt-6 pb-20">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="font-display font-bold text-xl text-gray-900 dark:text-white">All Hosting Orders</h1>
          <p className="text-sm text-gray-600 dark:text-slate-500 mt-0.5">Your web hosting accounts and their status.</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 p-10 text-center">
          ...
          <p className="text-gray-600 dark:text-slate-500 text-sm mb-4">No hosting orders yet.</p>
