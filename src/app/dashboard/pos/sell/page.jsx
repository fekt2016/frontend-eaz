      ...
      <div className="flex-1 flex flex-col gap-3">
        ...
        <div className="relative">
          <div className="absolute left-4 top-1/2 -translate-y-1/2 flex items-center gap-2 text-gray-500">
            {scanning
              ? <FaSpinner size={14} className="animate-spin text-amber-600 dark:text-amber-400" />
              : <FaBarcode size={14} />}
          </div>
          <input
            ref={scanRef}
            ...
            className="w-full pl-10 pr-10 py-3.5 rounded-xl bg-white dark:bg-gray-900 border-2 border-amber-500/50 focus:border-amber-500 text-gray-900 dark:text-white text-sm placeholder-gray-500 focus:outline-none transition"
            autoComplete="off"
            spellCheck={false}
          />
          {scanInput && (
          ...
          <div className="rounded-xl bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 overflow-hidden shadow-xl">
            ...
            {results.map(p => (
              ...
              >
                ...
                <p className="text-sm font-bold text-amber-600 dark:text-amber-400 ml-4">GH₵{p.sellingPrice.toLocaleString()}</p>
              </button>
            ))}
          </div>
        )}
          ...
          <div className="flex-1 overflow-y-auto">
            {cart.length === 0 ? (
              ...
              cart.map((item, idx) => (
                <div
                  key={item.partId}
                  className={`flex items-center gap-3 px-4 py-3 border-b border-gray-200 dark:border-gray-800 last:border-0 ${idx === cart.length - 1 ? "bg-amber-500/5" : ""}`}
                >
                  {/* Item info */}
      ...
      <div className="w-full lg:w-72 flex flex-col gap-3">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-5 space-y-2.5">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative w-28">
              ...
              <input
                ...
                placeholder="0"
                className="w-full pl-8 pr-2 py-1.5 rounded-lg bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-sm text-gray-900 dark:text-white focus:outline-none focus:border-amber-500 transition text-right"
              />
            </div>
          </div>
          ...
          <div className="flex justify-between text-base font-bold border-t border-gray-200 dark:border-gray-800 pt-2.5">
            ...
            <span className="text-amber-600 dark:text-amber-400">GH₵{total.toFixed(2)}</span>
          </div>
        </div>
        ...
        {showPay && (
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-amber-500/30 p-5 space-y-3">
            <p className="text-xs font-semibold text-amber-600 dark:text-amber-400 uppercase tracking-wide">Collect Payment</p>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-xl bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white text-base font-bold focus:outline-none focus:border-amber-500 transition"
                placeholder="0.00"
              />
            </div>
            ...
            {payMethod === "momo" && (
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white text-sm focus:outline-none focus:border-amber-500 transition"
                />
              </div>
            )}
