...
function StatCard({ label, value, icon: Icon, color = "text-amber-600 dark:text-amber-400", sub }) {
  return (
    ...
    <div className="space-y-7">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard label="Pending"          value={stats?.pendingJobs}    icon={FaClock}            color="text-amber-600 dark:text-amber-400" sub="In progress" />
      ...
      {uncollected.length > 0 && (
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-amber-500/30 overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-amber-500/20 bg-amber-500/5">
            <div className="flex items-center gap-2">
              <FaBell size={13} className="text-amber-600 dark:text-amber-400" />
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200 dark:border-gray-800">
          ...
          <Link href="/dashboard/pos/jobs" className="text-xs text-amber-600 dark:text-amber-400 hover:underline">View all →</Link>
        </div>
        {loading ? (
          ...
          <div className="p-8 text-center text-gray-500 text-sm">No jobs yet. <Link href="/dashboard/pos/jobs/new" className="text-amber-600 dark:text-amber-400 hover:underline">Create first job →</Link></div>
        ) : (
          <div className="divide-y divide-gray-200 dark:divide-gray-800">
