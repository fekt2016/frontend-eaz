    ...
    <div className="bg-white text-gray-900">
      ...
      <section className="pt-28 pb-16 px-4 border-b border-gray-100">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="font-display font-black text-4xl md:text-5xl text-gray-900 mb-5">Our Services</h1>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {iconStrip.map(({ icon: Icon, label, accent }) => (
              <div
                key={label}
                className="flex flex-col items-center gap-1.5 px-4 py-3 rounded-2xl border border-gray-100 bg-gray-50 min-w-[72px]"
              >
                <div
      ...
      <section className="py-20 px-4 bg-gray-50 border-y border-gray-100">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="rounded-2xl overflow-hidden border border-gray-100 shadow-sm bg-white p-5 space-y-3">
            {/* Mock browser bar */}
            <div className="flex items-center gap-1.5 mb-4">
              <span className="w-2.5 h-2.5 rounded-full bg-red-300" />
              <span className="w-2.5 h-2.5 rounded-full bg-yellow-300" />
              <span className="w-2.5 h-2.5 rounded-full bg-green-300" />
              <span className="flex-1 ml-2 h-5 rounded bg-gray-100 text-xs text-gray-400 flex items-center px-2">saiisai.com</span>
            </div>
              ...
              {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} className="rounded-xl bg-gray-50 border border-gray-100 overflow-hidden">
                  ...
                  <div className="p-2">
                    ...
                    <div className="h-2 rounded bg-amber-100 w-2/3" />
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="flex items-center justify-between pt-2 border-t border-gray-100">
              <div className="flex gap-1">
                {Array.from({ length: 4 }).map((_, i) => (
                  <div key={i} className="h-6 w-12 rounded bg-gray-100" />
                ))}
              </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-500 text-lg mb-2">We can help.</p>
