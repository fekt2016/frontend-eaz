    ...
    <div className="divide-y divide-gray-100 border border-gray-100 rounded-2xl overflow-hidden">
      {items.map((item, i) => (
        <div key={i} className="bg-white">
          ...
          >
            {item.q}
            {open === i ? <FaChevronUp className="text-gray-400 flex-shrink-0 ml-3" size={12} /> : <FaChevronDown className="text-gray-400 flex-shrink-0 ml-3" size={12} />}
          </button>
          {open === i && (
            <div className="px-6 pb-4 text-gray-500 text-sm leading-relaxed bg-gray-50">
              {item.a}
            </div>
          )}
        </div>
    ...
    <div className="bg-white text-gray-900">
      ...
      <section className="pt-28 pb-16 px-4 border-b border-gray-100">
        <div className="max-w-5xl mx-auto">
          <Link href="/services" className="text-xs text-gray-400 hover:text-gray-700 transition mb-6 inline-block">← All Services</Link>
          <div className="grid md:grid-cols-[1fr_300px] gap-10 items-start">
            <div>
              ...
              <h1 className="font-display font-black text-4xl md:text-5xl text-gray-900 mb-4">{service.title}</h1>
              <p className="text-gray-500 text-lg leading-relaxed">{service.tagline}</p>
            </div>
            <div className="p-6 rounded-2xl border border-gray-100 bg-gray-50 space-y-4">
              <div className="flex justify-between text-sm border-b border-gray-100 pb-3">
                <div><p className="text-gray-400 text-xs mb-1">Investment</p><p className="font-semibold text-gray-900">{service.investment}</p></div>
                <div className="text-right"><p className="text-gray-400 text-xs mb-1">Timeline</p><p className="font-semibold text-gray-900">{service.timeline}</p></div>
              </div>
      ...
      <section className="py-16 px-4 bg-gray-50 border-b border-gray-100">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="font-display font-bold text-2xl text-gray-900 mb-4">The Challenge</h2>
          <p className="text-gray-600 leading-relaxed">{service.challenge}</p>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12">
          <div>
            ...
            <h2 className="font-display font-bold text-2xl text-gray-900 mb-4">How We Solve It</h2>
          ...
          <div className="space-y-3">
            {service.process.map((p, i) => (
              <div key={i} className="flex gap-4 p-4 rounded-xl border border-gray-100 bg-gray-50">
                <span className="font-display font-bold text-gray-200 text-lg flex-shrink-0 w-7">{String(i + 1).padStart(2, "0")}</span>
                <div>
                  <h4 className="font-semibold text-gray-900 text-sm mb-0.5">{p.step}</h4>
      ...
      <section className="py-16 px-4 bg-gray-50 border-y border-gray-100">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12">
          <div>
            ...
            <h2 className="font-display font-bold text-2xl text-gray-900 mb-6">Deliverables</h2>
          ...
          <div className="p-7 rounded-2xl border border-gray-100 bg-white">
            ...
            <h3 className="font-display font-bold text-xl text-gray-900 mb-3">Saiisai Marketplace</h3>
            <p className="text-gray-500 text-sm leading-relaxed mb-5">{service.saiisaiExample}</p>
            <div className="flex gap-5 mb-5">
              {[["150+", "Sellers"], ["15k+", "Products"], ["4.7★", "Rating"]].map(([val, label]) => (
                <div key={label}><p className="font-bold text-gray-900">{val}</p><p className="text-gray-400 text-xs">{label}</p></div>
              ))}
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="font-display font-bold text-2xl text-gray-900 mb-6">Frequently Asked</h2>
      ...
      <section className="py-16 px-4 bg-gray-50 border-t border-gray-100">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-500 mb-7">Free consultation, no obligation. Let&apos;s talk about your project.</p>
          <div className="flex flex-wrap gap-3 justify-center">
            ...
            <Link href="/book-consultation" className="px-6 py-3 rounded-full border border-gray-300 text-gray-700 text-sm font-medium hover:bg-white transition">Book a Consultation</Link>
          </div>
        </div>
      </section>
    </div>
