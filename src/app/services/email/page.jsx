    ...
    <div className="bg-gray-50 dark:bg-slate-950 text-gray-900 dark:text-white">
      ...
      <section className="pt-28 pb-16 px-4 border-b border-gray-100 dark:border-slate-800">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-xs font-semibold uppercase tracking-widest text-amber-500 mb-4">Email Marketing</p>
      ...
      <section className="py-16 px-4 bg-gray-900 dark:bg-slate-900">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-7 text-sm">Book a free call. We&apos;ll look at your current situation and recommend the right email strategy for your business.</p>
          <div className="flex flex-wrap items-center justify-center gap-4">
