  ...
  return (
    <div className="max-w-2xl mx-auto space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-white">New Repair Job</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {selectedCustomer ? (
            <div className="flex items-center justify-between p-3 rounded-xl bg-amber-500/10 border border-amber-500/30">
              <div>
                ...
                {selectedCustomer.name && <p className="text-xs text-gray-400">{selectedCustomer.name}</p>}
              </div>
              <button
                type="button"
        ...
        {/* Device info */}
        <div className="bg-gray-900 rounded-2xl border border-gray-800 p-5 space-y-4">
          <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide">Device</p>
        ...
        <div className="bg-gray-900 rounded-2xl border border-gray-800 p-5 space-y-4">
          ...
          {/* Diagnosis toggle */}
          <div className="flex items-start gap-3 p-4 rounded-xl bg-gray-800/60 border border-gray-700">
            <input
              type="checkbox"
            ...
            <div className="flex-1">
              <label htmlFor="requiresDiagnosis" className="text-sm text-white font-medium cursor-pointer">
