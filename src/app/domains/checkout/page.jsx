  ...
  return (
    <div className="min-h-[60vh] bg-paper dark:bg-ink px-4 pt-24 pb-20">
      <div className="max-w-2xl mx-auto">
        <Link href="/domains" className="text-gray-600 dark:text-slate-500 text-sm hover:text-gray-700 dark:hover:text-slate-300 transition mb-8 inline-block">
          ← Back to Domains
        </Link>
        ...
        <p className="text-brand-500 font-semibold mb-8">${price}<span className="text-gray-600 dark:text-slate-500 font-normal text-xs">/yr</span></p>

        <div className="flex flex-wrap gap-4 mb-8 text-xs text-gray-600 dark:text-slate-500">
