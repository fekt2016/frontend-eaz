      ...
      <div className="sticky top-[64px] z-20 bg-white/95 dark:bg-ink/95 backdrop-blur border-b border-gray-100 dark:border-slate-800">
        <div className="max-w-6xl mx-auto px-4 py-3 flex flex-col lg:flex-row gap-3 items-start lg:items-center justify-between">
          ...
          <div className="flex items-center gap-3 w-full lg:w-auto">
            <div className="relative w-full sm:w-52">
              ...
              {q && (
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-600 hover:text-gray-700 dark:hover:text-white text-xs"
                >
                  ×
                </button>
              )}
            ...
            <p className="hidden sm:block text-xs text-gray-600 dark:text-slate-500 whitespace-nowrap">{pagination.total} products</p>
          </div>
        </div>
      </div>
      ...
      <section className="py-14 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              <p className="font-mono text-eyebrow font-bold uppercase text-brand-ink dark:text-brand-400 mb-1">
            ...
            <p className="sm:hidden text-xs text-gray-600 dark:text-slate-500">{pagination.total} products</p>
          </div>
...
<div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-gray-200 dark:border-slate-700 bg-paper dark:bg-slate-900 px-6 py-16 text-center">
              <AlertTriangle size={24} className="text-gray-600 dark:text-slate-500 mb-3" />
              <p className="font-semibold text-gray-900 dark:text-white mb-2">Something went wrong</p>
              <p className="text-gray-600 dark:text-slate-500 text-sm mb-5 max-w-sm">{error}</p>
              <button
                type="button"
                onClick={load}
...
<div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-gray-200 dark:border-slate-700 bg-paper dark:bg-slate-900 px-6 py-16 text-center">
              <ShoppingBag size={24} className="text-gray-600 dark:text-slate-500 mb-3" />
  ...
  return (
    <article className="group flex flex-col overflow-hidden rounded-2xl border border-gray-100 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-gray-200 dark:hover:border-slate-700 hover:shadow-md hover:-translate-y-1 transition duration-300">
      ...
      <div className="flex flex-1 flex-col p-5">
        <p className="font-mono text-eyebrow font-bold uppercase text-brand-ink dark:text-brand-400 mb-0.5">{product.category}</p>
        ...
        <p className="text-gray-600 dark:text-slate-500 text-xs leading-relaxed line-clamp-3 mb-4 flex-1">{product.description}</p>
