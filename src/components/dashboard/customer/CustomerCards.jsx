      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 dark:text-slate-500 capitalize">{order.billingCycle} · {formatGhsMajor(order.amount)}</p>
          </div>
        </div>
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 dark:text-slate-500">{order.years} year{order.years > 1 ? "s" : ""} · {formatGhsMajor(order.price)}</p>
          </div>
        </div>
        <StatusBadge status={order.status} />
      </div>
